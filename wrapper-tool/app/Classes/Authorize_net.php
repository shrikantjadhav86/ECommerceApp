...
class Authorize_net
{
    ...
    private $api_login_id = '8Q87hKq5';			// API Login ID
    private $api_transaction_key = '9C88H4MpP4AtgU8F';	// API Transaction Key
    private $api_url = '';				// Where we postin' to?
//    private $api_url = 'https://apitest.authorize.net/xml/v1/request.api';				// Where we postin' to?
