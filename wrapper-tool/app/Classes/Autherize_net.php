...
class Authorize_net
{
    ...
    private $api_login_id = AUTHORIZE_LOGIN_NAME;			// API Login ID
    private $api_transaction_key = AUTHORIZE_TRANSACTION_KEY;	// API Transaction Key
    private $api_url = AUTHORIZE_ARB_TEST_REQUEST;				// Where we postin' to?
